...
import (
	interfaces "learnExample/conspect/metanit/6_interfaces"
)
...
func main() {
	...
	//base.ExampleArithOperations()                             // 2.5 Арифметические операции
	//base.ExampleConditionalExpressions()                      // 2.6 Условные выражения
	//base.ExampleBitwiseOperations()                           // 2.7 Поразрядные операции
	...
	//types_ex.ExampleMethods()                                 // 4.3 Методы
	//types_ex.ExampleMethodsPointers()                         // 4.4 Методы указателей

	//package_and_their_imports.ExamplePackageAndTheirImports() // 5.1 Пакеты и их импорт
	//package_and_their_imports.ExampleIntroToModules()         // 5.2 Введение в модули

	interfaces.ExampleIntroInterfaces() // 6.1 Введение в интерфейсы
